...
class _PenjadwalanPageState extends State<PenjadwalanPage> {
  ...
  Map<String, List<JadwalWorkout>> _groupJadwalByTime(List<JadwalWorkout> jadwals) {
    ...
    for (var jadwal in jadwals) {
      try {
        final hourStr = jadwal.jam.split(':')[0];
        ...
        // Fallback ke pagi jika parsing error
        grouped['Pagi']!.add(jadwal);
      }
    }
    ...
    for (var entry in grouped.entries) {
      entry.value.sort((a, b) => a.jam.compareTo(b.jam));
    }
                  ...
                  children: [
                    ...
                    if (jadwal.workout != null) ...[
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: _getWorkoutStatusColor(jadwal.workout!.status),
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              _getWorkoutStatusIcon(jadwal.workout!.status),
                              color: Colors.white,
                              size: 12,
                            ),
                            const SizedBox(width: 4),
                            Text(
                              jadwal.workout!.statusDisplay,
                              style: const TextStyle(
                                color: Colors.white,
                                fontSize: 12,
                                fontWeight: FontWeight.bold,
  ...
  void _showWorkoutDetail(JadwalWorkout jadwal) {
          ...
          child: Column(
            ...
            children: [
              ...
              if (jadwal.workout != null) ...[
                ...
                const SizedBox(height: 8),
                Text(
                  'Nama: ${jadwal.workout!.namaWorkout}',
                  style: TextStyle(
                    color: PurplePalette.textSecondary,
                    fontSize: 16,
                  ),
                ...
                Text(
                  'Jenis: ${jadwal.workout!.exercisesDisplay}',
                  style: TextStyle(
                    color: PurplePalette.textSecondary,
                    fontSize: 16,
                  ),
                ...
                const SizedBox(height: 4),
                Text(
                  'Status: ${jadwal.workout!.statusDisplay}',
                  style: TextStyle(
                    color: PurplePalette.textSecondary,
                    fontSize: 16,
                  ),
